...
These premade character sheets are available to claim. Each character is built using the custom ruleset at level 1.

---

### 1. Human Warrior — Noble Background
...
**Hit Points:** 12 (10 + 2 Might modifier)
**Evasion:** 17 (10 + 1 Finesse modifier + 6 chain mail)
**Speed:** 30 ft.
**Hit Die:** d10

**Starting Ability:** Armored Defense (+1 Evasion while wearing medium or heavy armor, raising effective Evasion to 18)

**Equipment:**

- Chain mail
- Longsword (1d8 + Might slashing)
- Shield (+2 Evasion, already factored above as total armor value 6)
- Light crossbow and 20 bolts
- Explorer's pack
- A signet ring bearing your family crest
- 10 gp
...
### 2. Human Warrior — Folk Hero Background
...
**Hit Points:** 12 (10 + 2 Might modifier)
**Evasion:** 16 (10 + 0 Finesse modifier + 6 chain mail)
**Speed:** 30 ft.
**Hit Die:** d10

**Starting Ability:** Power Strike (+2 damage on one melee attack per turn)

**Equipment:**

- Chain mail
- Greataxe (1d12 + Might slashing)
- Two handaxes (1d6 + Might slashing, can be thrown)
- Explorer's pack
- A set of common clothes and a shovel
- 10 gp
...
### 3. Halfling Ranger — Criminal Background
...
**Hit Points:** 9 (10 + (-1) Might modifier)
**Evasion:** 14 (10 + 2 Finesse modifier + 2 leather armor)
**Speed:** 25 ft.
**Hit Die:** d8

**Starting Ability:** Lightfoot (advantage on Finesse checks for stealth and hiding)

**Equipment:**

- Leather armor
- Two daggers (1d4 + Finesse piercing)
- Shortbow and 20 arrows (1d6 + Finesse piercing)
- Thieves' tools
- Burglar's pack (includes a backpack, caltrops, a hooded lantern, rope, and rations)
- A dark hooded cloak
- 10 gp
...
### 4. Elven Mage — Acolyte Background
...
**Hit Points:** 9 (10 + (-1) Might modifier)
**Evasion:** 11 (10 + 1 Finesse modifier + 0 no armor)
**Speed:** 30 ft.
**Hit Die:** d6

**Mana:** 7 (5 + 2 Wit modifier)

**Starting Ability:** Arcane Affinity (+1 to spell attack rolls and spell DCs)

**Known Spells (4 minor spells):**

- Magic Missile (force damage, auto-hit)
- Fire Bolt (ranged spell attack, fire damage)
- Shield (+3 Evasion until start of next turn, costs 1 mana)
- Detect Magic (sense magical auras nearby, costs 1 mana)

**Equipment:**

- Quarterstaff (1d6 + Might bludgeoning)
- Arcane focus (crystal orb)
- Scholar's pack (includes a backpack, ink, quill, parchment, and books of lore)
- Robes
- A holy symbol of Oghma
- 10 gp
...
### 5. Dwarven Bard — Soldier Background
...
**Hit Points:** 11 (10 + 1 Might modifier)
**Evasion:** 13 (10 + (-1) Finesse modifier + 4 scale mail)
**Speed:** 25 ft.
**Hit Die:** d8

**Mana:** 6 (4 + 2 Presence modifier)

**Starting Ability:** Inspiring Presence (once per short rest, grant one ally advantage on their next roll)

**Known Spells (3 minor spells):**

- Healing Word (restore HP to one ally within range, costs 1 mana)
- Guidance (grant an ally +1d4 on their next check, costs 1 mana)
- Vicious Mockery (target makes a Wit save or takes psychic damage and has disadvantage on next attack)

**Equipment:**

- Scale mail
- War hammer (1d8 + Might bludgeoning)
- Shield (+2 Evasion, already factored above as total armor value 4)
- Hand drum (doubles as a musical focus for spellcasting)
- Explorer's pack
- A banner bearing your old mercenary company's insignia
- 10 gp

**Personality and Background:**

Trained as a soldier on the island of Mintarn, you traveled to Neverwinter as part of a mercenary company that serves as both army and city watch. You grew disillusioned with your fellow soldiers, who seem to enjoy their authority at the expense of the people they're supposed to protect. Everything came to a head recently, when you disobeyed an order and followed your conscience. You were suspended from active duty, though you kept your rank and your connection to the mercenaries. Since then, you have devoted yourself to uplifting and protecting the common folk through word and song.
