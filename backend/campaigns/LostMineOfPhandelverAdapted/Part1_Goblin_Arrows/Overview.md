...
Any character can drive a wagon, and no particular check is necessary. Two oxen pull the wagon. If no one is holding the reins, the oxen stop where they are.
...
When you're ready, continue with the " [Goblin Ambush](Goblin_Arrows.md#GoblinAmbush)" section.
