...
- **See [spell_list/INDEX.md](spell_list/INDEX.md) for complete Mage and Bard spell lists.**
...
- **See [class_abilities/INDEX.md](class_abilities/INDEX.md) for complete class ability tables (Warrior, Mage, Ranger, Bard).**
